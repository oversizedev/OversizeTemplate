...
extension ___VARIABLE_modelName___Destinations: NavigationDestination {
    public var body: some View {
        ...
        case let .___VARIABLE_modelVariableName___CategoryDetails___VARIABLE_modelName___Category(___VARIABLE_modelVariableName___Category: ___VARIABLE_modelVariableName___Category):
...
extension ___VARIABLE_modelName___Destinations: Hashable, Equatable {
    public func hash(into hasher: inout Hasher) {
        ...
        case let .___VARIABLE_modelVariableName___EditId(id, _):
            hasher.combine("___VARIABLE_modelVariableName___EditId")
            hasher.combine(id)
        case let .___VARIABLE_modelVariableName___Edit(___VARIABLE_modelVariableName___, _):
        ...
        case let .___VARIABLE_modelVariableName___CategoryDetails(id):
            ...
            hasher.combine(id)
        case let .___VARIABLE_modelVariableName___CategoryDetails___VARIABLE_modelName___Category(___VARIABLE_modelVariableName___Category):
            hasher.combine("___VARIABLE_modelVariableName___CategoryDetails___VARIABLE_modelName___Category")
        ...
        case let .___VARIABLE_modelVariableName___CategoryEditId(id, _):
            hasher.combine("___VARIABLE_modelVariableName___CategoryEditId")
            hasher.combine(id)
        case let .___VARIABLE_modelVariableName___CategoryEdit(___VARIABLE_modelVariableName___Category, _):
    ...
    public static func == (lhs: ___VARIABLE_modelName___Destinations, rhs: ___VARIABLE_modelName___Destinations) -> Bool {
        ...
        case (.___VARIABLE_modelVariableName___Create, .___VARIABLE_modelVariableName___Create):
            return true
        case let (.___VARIABLE_modelVariableName___EditId(lhsId, _), .___VARIABLE_modelVariableName___EditId(rhsId, _)):
            return lhsId == rhsId
        case let (.___VARIABLE_modelVariableName___Edit(lhs___VARIABLE_modelName___, _), .___VARIABLE_modelVariableName___Edit(rhs___VARIABLE_modelName___, _)):
            return lhs___VARIABLE_modelName___.id == rhs___VARIABLE_modelName___.id
        ...
        case let (.___VARIABLE_modelVariableName___CategoryDetails(lhsId), .___VARIABLE_modelVariableName___CategoryDetails(rhsId)):
            return lhsId == rhsId
        case let (.___VARIABLE_modelVariableName___CategoryDetails___VARIABLE_modelName___Category(lhsCategory), .___VARIABLE_modelVariableName___CategoryDetails___VARIABLE_modelName___Category(rhsCategory)):
        ...
        case (.___VARIABLE_modelVariableName___CategoryCreate, .___VARIABLE_modelVariableName___CategoryCreate):
            return true
        case let (.___VARIABLE_modelVariableName___CategoryEditId(lhsId, _), .___VARIABLE_modelVariableName___CategoryEditId(rhsId, _)):
            return lhsId == rhsId
        case let (.___VARIABLE_modelVariableName___CategoryEdit(lhsCategory, _), .___VARIABLE_modelVariableName___CategoryEdit(rhsCategory, _)):
            return lhsCategory.id == rhsCategory.id
        default:
            return false
        }
