...
// MealProductCategoryEditView.swift, created on 27.07.2025
//
...
@View(module: MealProductCategoryEdit.self)
public struct MealProductCategoryEditView: ViewProtocol {
    @FocusState private var focusedField: MealProductCategoryEditViewState.FocusField?
...
private extension MealProductCategoryEditView {
