...
public enum ___VARIABLE_categoryName___FilterType: String, CaseIterable, Identifiable, Sendable {
    ...
    public var title: String {
        switch self {
        case .standard:
            "All ___VARIABLE_categoryPluralVariableName___"
        case .archived:
            "Archived"
        case .favorites:
            "Favorites"
    ...
    public var emptyStateTitle: String {
        switch self {
        case .standard:
            "No ___VARIABLE_categoryPluralVariableName___ Yet"
        case .archived:
    ...
    public var emptyStateSubtitle: String? {
        switch self {
        case .standard:
            "Create ___VARIABLE_categoryPluralVariableName___ to organize your ___VARIABLE_modelPluralVariableName___"
        case .archived:
