...
public enum ___VARIABLE_modelName___Destinations {
    ...
    case ___VARIABLE_modelVariableName___Details(___VARIABLE_modelVariableName___: ___VARIABLE_modelName___)
    case ___VARIABLE_modelVariableName___create
    case ___VARIABLE_modelVariableName___Edit(id: UUID)
    case ___VARIABLE_modelVariableName___Edit(___VARIABLE_modelVariableName___: ___VARIABLE_modelName___)
}
...
extension ___VARIABLE_modelName___Destinations: NavigationDestination {
    public var body: some View {
        ...
        case let .___VARIABLE_modelVariableName___Details(___VARIABLE_modelVariableName___: ___VARIABLE_modelVariableName___):
        ...
        case let .___VARIABLE_modelVariableName___Edit(___VARIABLE_modelVariableName___: ___VARIABLE_modelVariableName___):
    ...
    public var method: NavigationMethod {
        switch self {
        case .___VARIABLE_modelVariableName___create, .___VARIABLE_modelVariableName___Edit:
            .managedSheet
        default:
            .push
        }
