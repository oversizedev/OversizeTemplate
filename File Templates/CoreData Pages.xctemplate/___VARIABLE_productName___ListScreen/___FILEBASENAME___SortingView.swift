...
public struct ___FILEBASENAMEASIDENTIFIER___: View {
    ...
    public init(
        _ sortingTyps: [___VARIABLE_CoreDataModel___.___VARIABLE_CoreDataModel___Properties],
        selection: Binding<___VARIABLE_CoreDataModel___.___VARIABLE_CoreDataModel___Properties>,
